...
@Component
class StringCommandArgumentProvider : CommandArgumentProvider<String> {
    override suspend fun cast(context: CommandContext, argument: String?): String {
        return argument ?: throw ArgumentFeedback.RequireArgument
    }
