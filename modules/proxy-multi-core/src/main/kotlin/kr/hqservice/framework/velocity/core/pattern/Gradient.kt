...
import kr.hqservice.framework.velocity.core.extension.applyColors
import kr.hqservice.framework.velocity.core.extension.withoutColor
...
internal object Gradient : TextColorPattern {
    ...
    private fun generateGradient(firstColor: Color, lastColor: Color, size: Int): List<Color> {
